        ...
        <div className="row">
            ...
            <p className="Parrafo">
                        <h2>¡BIENVENIDO A NUESTRA TIENDA ONLINE!</h2>
                            Somos una empresa que creamos una amplia variedad de muebles y los creamos a la medida que necesites para que se adapten a tu hogar!
                            Nuesros articulos son  ideales para que puedas darle un toque super canchero a cada rinconcito de tu hogar.
